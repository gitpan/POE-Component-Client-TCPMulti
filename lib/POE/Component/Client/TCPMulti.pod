...
=head2 connect ADDRESS, PORT


=head2 connect ADDRESS, PORT, BIND_ADDRESS


=head2 connect ADDRESS, PORT, BIND_ADDRESS, BIND_PORT


=head2 connect C_HEAP_REF, ADDRESS, PORT


=head2 connect C_HEAP_REF, ADDRESS, PORT, BIND_ADDRESS


=head2 connect C_HEAP_REF, ADDRESS, PORT, BIND_ADDRESS, BIND_PORT
